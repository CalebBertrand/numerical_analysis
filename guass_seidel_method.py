...
def guass_seidel_method(x, equations, n):
    print(f"n = {n}, x = {x}")
    for _ in range(n):
        print()
        x_new = []
        for key in equations.keys():
            ...
            x_new.append(round(equations[key]['function'](x_temp), 4))
            print(f"{key} = {equations[key]['to_string'](x_temp)} = {x_new[-1]}")
        x = x_new
        print(f"x = {x}")
...
print("a)")
guass_seidel_method([0, 0, 0], equations_a, 2)
print()

print("b)")
guass_seidel_method([0, 0, 0], equations_b, 2)
print()

print("c)")
guass_seidel_method([0, 0, 0, 0, 0], equations_c, 2)
print()

print("d)")
guass_seidel_method([0, 0, 0, 0, 0], equations_d, 2)
print()